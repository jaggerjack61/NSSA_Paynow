                        ...
                        <?php $__currentLoopData = $plan->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row">
                               <div class="col-8"><?php echo e($item->name); ?></div>
                                <div class="col-4"><a class="btn btn-danger" href="<?php echo e(route('delete-pricing-item',$item->id)); ?>">Delete</a></div>
                            </div>
                            <hr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    </td>
                    <td><a class="btn btn-danger" href="<?php echo e(route('delete-pricing',$plan->id)); ?>">Delete</a>
                        <a class="btn btn-success" data-toggle="modal" data-target="#addItemModal<?php echo e($plan->id); ?>">Add Item</a></td>
                </tr>


                            <div class="modal fade" id="addItemModal<?php echo e($plan->id); ?>" tabindex="-1" aria-labelledby="addItemModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
